...
function PrivacyPolicy() {
  return (
    <div className="w-full text-[#ccc] text-child flex flex-col  gap-4">
      <p>
        Our Company Gebeta Software PLC operates Gebeta Map API This page
      ...
      <p>
        ...
        browser type, browser version, and the pages of our Site that you visit,
        ...
        Analytics that collect, monitor and analyze this. The Log Data section
        is for businesses that use analytics or tracking services in websites or
      ...
      <p>
        ...
        email (email newsletters) or other methods.
      </p>
      <h2>Security</h2>
      <p>
        The security of your Personal Information is important to us, but
        remembers that no method of transmission over the Internet, or method of
      ...
      <p>
        This Privacy Policy is effective as of on January 12, 2023 and will
