...
function Index() {
  const [animeClassK,setAnimeClassK] = useState("");
  const [animeClassM,setAnimeClassM] = useState("");
  const exploreKitchen = (ev) => {
    ev.preventDefault();
    setAnimeClassK('swing-left-fwd');
    setAnimeClassM('swing-right-bck');
  }
  return (
    <div className="w-full h-screen">
      <div className="w-full h-full flex font-bold overflow-clip">

        {/* Gebeta Kitchens */}
        <div className={"flex-1  flex flex-col text-[#F29D38] "+animeClassK}>
          <div className="flex-1 flex px-10 py-7">
            ...
            <div className="flex list-none gap-5 font-normal items-center">
              <li><a href='/#'>contact us</a></li>
              <li><a href='/#'>about</a></li>
            </div>
          </div>

          <div className="h-[70%]  pl-10  flex">
            ...
            <div className=" flex items-center overflow-clip">
              <h1 className="translatee-x-1/2 h-[70%] ">
                <img className="h-full w-[110px] object-cover object-left" src={require('../../assets/images/orange.png')} alt='be' />
              </h1>
            </div>
          </div>

          <div className="flex-1 pl-10 py-7">
            <a href="/#" className="btn theme-light px-7 py-3 border border-[#ccc]" 
             onClick={(ev) => exploreKitchen(ev)}
            >Explore</a>
          </div>
        </div>
        ...
        {/* Gebeta Maps */}
        <div className={"flex-1  flex flex-col bg-[#F29D38] text-white "+animeClassM}>
          <div className="flex-1 flex flex-row-reverse gap-5 px-10 py-7 list-none items-center">
            <li><a href='/#'>
          ...
          <div className="h-[70%]  pr-10 flex flex-row-reverse">
            <div className="flex flex-col flex-1  justify-center">
              <div className="flex-1 text-right "></div>
            ...
            <div className=" flex items-center overflow-clip">
              <h1 className="translatee-x-1/2 h-[70%] ">
                <img className="h-full w-[110px] object-cover object-right" src={require('../../assets/images/be.png')} alt='be' />
              </h1>
            </div>
          </div>

          <div className="flex-1 pr-10 py-7 text-right">
